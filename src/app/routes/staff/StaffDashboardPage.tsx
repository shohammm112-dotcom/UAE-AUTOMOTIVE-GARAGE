...
import { Wrench, FileText, Activity, AlertCircle } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          <h3 className="font-semibold text-amber-900 text-sm">Dashboard Data is Mocked / Deferred</h3>
          <p className="text-sm text-amber-800 mt-1">
            The internal workshop list endpoints are currently deferred (API Gap). This dashboard uses placeholder metrics representing what will be powered by the real ERP capabilities.
          </p>
        </div>
      </div>
